...
<section class="services-area section-gap">
    <div class="container">
        <div class="row single-service">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-dark"><h3 class="text-white">Drivers</h3></div>
                    <div class="card-body">
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            $query = "SELECT count(driver_id) FROM books WHERE driver_id = $driver_id AND driver_status != 'completed'";
                                            $result1 = mysqli_query($conn, $query);
                                            $row1 = mysqli_fetch_array($result1);
                                            echo $total_savings = $row1[0];
                                            ?></td>
