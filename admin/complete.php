...
<section class="services-area section-gap">
    <div class="container">
        <div class="row single-service">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header bg-success"><h2 class="text-white">Completed Bookings</h2></div>
                    <div class="card-body">
                        <table class="table table-bordered table-sm">
                            ...
                            <?php
                            $sql = "SELECT * FROM books JOIN users ON books.user_id = users.user_id
                            JOIN drivers ON books.driver_id = drivers.driver_id    
                            WHERE status != 'pending' and driver_status = 'completed'";
                                ...
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td class="font-weight-bold"><?php echo $driver_name ?></td>
                                        <td class="text-success font-weight-bold"><?php echo $driver_status ?></td>
                                        <td><?php echo $date ?></td>
                                    </tr>
                                    <?php
                                }
