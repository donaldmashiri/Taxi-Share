...
<section class="services-area section-gap">
    <div class="container">
        <div class="row single-service">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header bg-dark"><h2 class="text-white">All Bookings</h2></div>
                    <div class="card-body">
                        <table class="table table-bordered table-sm">
                            ...
                            <?php
                            $sql = "SELECT * FROM books JOIN users ON books.user_id = users.user_id ORDER BY book_id DESC";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<p class='text-danger'>No Bookings Made</p>";
                            }
                            ?>
